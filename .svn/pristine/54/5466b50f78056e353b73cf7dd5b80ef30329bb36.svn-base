...
public class DeviceOSUnset {
        ...
        @Test
        public void testDeviceUnset() throws Exception {
                selenium.open("http://uatplatformv2.adtheorent.com/");
                ...
                Thread.sleep(8000);
                selenium.check("id=chkbx_SelectAllSmartphones");
                selenium.click("id=chkbx_SelectAllSmartphones");
                Thread.sleep(2000);
                ...
                selenium.waitForPageToLoad("30000");
               // verifyEquals("None", selenium.getText("id=spandevice"));
        }
